    ...
    <div class="w-full relative overflow-hidden bg-gray-200 h-full">
        <div class="bg-white w-full h-16 px-4 py-2 flex justify-between items-center relative z-1">
            <div class="flex gap-4 justify-center items-center">
                ...
                <p class="text-gray-800 font-medium">Sergio Gutierrez</p>
            </div>
            <div class="flex gap-4 justify-center items-center relative">
                ...
                <div role="menu" id="convo-settings" class="opacity-0 absolute inset-e-0 top-16 z-auto w-0 h-0 overflow-hidden rounded border border-gray-200 bg-white shadow-sm transition-all duration-200">
                    ...
                    <button type="button" class="block w-full px-3 py-2 text-sm font-medium text-red-700 transition-colors hover:bg-red-50 ltr:text-left rtl:text-right cursor-pointer">
                        Delete
                    </button>
                </div>
            </div>
        </div>
        <div class="flex flex-col justify-start gap-4 py-2 px-4 h-full">
                <div class="bg-indigo-800 rounded-xl rounded-bl-none max-w-1/2 self-start py-2 px-4">
                    <p class="text-white">Hola, este es un mensaje de prueba</p>
                    <div class="flex justify-between items-center mt-2">
                        <span class="text-gray-200 text-[10px]">12/06 12:06pm</span>
                        <span class="text-gray-200 text-[10px]">read</span>
                    </div>
                </div>
                <div class="bg-indigo-800 rounded-xl rounded-br-none max-w-1/2 self-end py-2 px-4">
                    <p class="text-white">
        ...
        <form class="sticky bottom-0 w-full py-2 px-4 bg-white h-16 flex items-center">
            <input class="w-15/16 h-full px-4 py-2 border border-indigo-800 rounded-l-lg" type="text" name="message" id="message" placeholder="Write a message...">
            <button class="w-1/16 h-full bg-indigo-800 rounded-r-lg py-2 px-4 text-white hover:bg-indigo-900 cursor-pointer group">
