    ...
    <div class="w-full bg-gray-200 h-full px-8 py-4">
        <div class="border-b border-gray-200">
            <div role="tablist" class="-mb-px flex gap-4">
                <button role="tab" aria-selected="true" class="flex items-center gap-2 border-b-2 border-blue-600 px-4 py-2 text-sm font-medium text-blue-600 transition-colors hover:text-blue-700">
                ...
                <button role="tab" aria-selected="false" class="flex items-center gap-2 border-b-2 border-transparent px-4 py-2 text-sm font-medium text-gray-600 transition-colors hover:text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
